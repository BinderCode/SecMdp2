...
import sys
import os  #VsCode中的“当前根路径”是动态变化的。

# print("当前绝对路径=========",os.path.abspath('clip_moco.py'))#查看当前绝对路径
os.chdir(sys.path[0])#使用当前目录作为根目录
sys.path.append("..") #返回上一级目录
# print("当前绝对路径2=========",os.path.abspath('clip_moco.py'))#查看当前绝对路径
...
# Cell
try:
    from self_supervised.simple_tokenizer import SimpleTokenizer
except:
    raise ImportError("""
