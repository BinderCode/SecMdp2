...
import sys
import os   
#print("当前绝对路径2=========",os.path.abspath('training_clip.py'))#查看当前绝对路径
...
# Cell
try:
    from self_supervised.simple_tokenizer import SimpleTokenizer   #注意两个clip文件是否会冲突
except:
    raise ImportError("""
...
def vitb32_config(input_res, context_length, vocab_size):
    "ViT-B/32 configuration, uses 32x32 patches"  #配置返回dict键值对  
